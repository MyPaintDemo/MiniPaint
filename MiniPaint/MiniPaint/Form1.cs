...
namespace MiniPaint
{
    public partial class Form1 : Form
    {
        ...
        public static string dosyaKayitYolu = "";
        public static bool arkaPlanResmi;
       ...
       //Setting the Canvas Color
        ...
        {
            DialogResult cevap;
            cevap = MessageBox.Show("Resmi kaydetmek istermisiniz..?", "Uyarı", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
